...
uri="http://java.sun.com/jsp/jstl/fmt" %> <%@ taglib uri="http://java.sun.com/jsp/jstl/functions"
prefix="fn"%> <% String getPathName = (String)session.getAttribute("pathName");
...
<html>
  <head>
    ...
    <title>BizCore 2024.02.26</title>
  </head>
  <body>
    ...
    <div class="header">
      ...
      <div class="mainTopMenu">
        <div data-keyword="business" data-path="/" onclick="CommonDatas.topMenuClick(this)">
          업무관리
        </div>
        <div data-keyword="gw" data-path="/gw/home" onclick="CommonDatas.topMenuClick(this)">
          전자결재
        </div>
        <div
          data-keyword="accounting"
          data-path="/accounting/home"
          onclick="CommonDatas.topMenuClick(this)"
        >
          회계관리
        </div>
      </div>
