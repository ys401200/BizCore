      ...
      <div class="contentHeaders">
        ...
        <div class="listRange">
          <input
            ...
            step="10"
            value="0"
            oninput="CommonDatas.listRangeChange(this, CommonDatas.Temps.techSet.drawTechList);"
          />
        ...
        <div class="listSearchInput">
          <input
            ...
            id="searchAllInput"
            onkeyup="CommonDatas.Temps.techSet.searchInputKeyup();"
        ...
        <div class="crudBtns">
          <button
            type="button"
            class="crudAddBtn"
            onclick="CommonDatas.Temps.techSet.techInsertForm();"
          >
            등록
          </button>
          ...
          <a
            href="#"
            onclick="CommonDatas.hideDetailView(CommonDatas.Temps.techSet.drawTechList);"
            class="detailBackBtn"
            style="display: none"
            >Back</a
          >
