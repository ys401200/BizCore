      ...
      <div class="contentHeaders">
        ...
        <div class="listRange">
          <input
            ...
            step="10"
            value="0"
            oninput="CommonDatas.listRangeChange(this, CommonDatas.Temps.contSet.drawContList);"
          />
        ...
        <div class="listSearchInput">
          <input
            ...
            id="searchAllInput"
            onkeyup="CommonDatas.Temps.contSet.searchInputKeyup();"
        ...
        <div class="crudBtns">
          ...
          <button
            type="button"
            class="crudAddBtn"
            onclick="CommonDatas.Temps.contSet.contInsertForm();"
          >
            등록
          </button>
          ...
          <a
            href="#"
            onclick="CommonDatas.hideDetailView(CommonDatas.Temps.contSet.drawContList);"
            class="detailBackBtn"
            >Back</a
          >
        </div>
