	  ...
	  <div class="mainDiv">
		...
		<div class="list_detail">
		  ...
		  <div class="slaesSche scheData">
			<!-- <div class="insertedSalesSche">
			  <input type="date" class="salesDate"
				style="padding:0.3em; border-bottom: 1px solid black; border-right: 1px solid black;" />
			  <input type="text" class="salesType"
				style="padding:0.3em; border-bottom: 1px solid black; border-right: 1px solid black;" />
			  <input type="text" class="salesTitle"
				style="padding:0.3em; border-bottom: 1px solid black; border-right: 1px solid black;" />
			  <input type="text" class="salesContent"
				style="padding:0.3em; border-bottom: 1px solid black; border-right: 1px solid black;" />
			  <input type="text" class="salesWriter"
				style="padding:0.3em; border-bottom: 1px solid black; border-right: 1px solid black;" />
			  <input type="text" class="salesPlace"
				style="padding:0.3em; border-bottom: 1px solid black; border-right: 1px solid black;" />
			</div> -->
		  </div>
