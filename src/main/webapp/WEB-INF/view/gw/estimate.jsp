	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<body>
			...
			<div class="mainBtnDiv">
				<div class="savedLineContainer"><select><option val="">자주 쓰는 결재선</option></select></div>
			
				<button class="lineCreateBtn" onclick="createLine()">결재선 생성</button>
				<button>기안하기</button>
			</div>
			...
			<div class="estDiv" style="border : 1px solid black; width: 1050px; height :1200px ">
				...
				<style>
					...
					.subDataDetail>div {
						text-align: center;
						display: grid;
						grid-template-columns: 15% 10% 10% 15% 10% 15% 15% 10%;
					...
					.detailDiv {
						display: grid;
						grid-template-columns: 5% 15% 15% 15% 10% 5% 15% 20%;
						text-align: center;
						border-left: 1px solid black;
					}
					...
					.detailcontentDiv {
						...
						margin-left: 2em;
						margin-right: 2em;
						grid-template-columns: 5% 15% 15% 15% 10% 5% 15% 15% 5%;
					}
					...
					/* 결재선 관련 css  */
					.lineGridContainer:nth-of-type(1) {
					...
					.lineGridContainer:nth-of-type(2) {
						...
						<div class="infoline">
							<div class="info">
								<div class="infoDiv">
									...
									<input class="inputsAuto infoContent" placeholder="문서 번호는 승인완료 후 생성됩니다." type="text" id="doc_Form_SalesReport_no"
              ...
              padding:0.3em;" />
					...
					<div class="list_detail">
						<div class="subDataDetail">
							...
							<div>
								<div>매출처 담당자</div><input type="text" class="inputs" data-detail=""
									onkeyup="this.dataset.detail=this.value" id="doc_Form_SalesReport_custmemberName"
									style="padding:0.5em;">
								<div>엔드유저</div> <input type="text" class="inputs" data-detail=""
									onkeyup="this.dataset.detail=this.value" id="doc_Form_SalesReport_endCustName">
								<div>진행단계</div> <select class="inputs" id="doc_Form_SalesReport_soppStatus"
									data-detail="" onchange="this.dataset.detail=this.value">
							...
							<div>
								...
								<div>매출예정일</div> <input class="inputs" type="date" data-detail=""
									onchange="this.dataset.detail=this.value" id="doc_Form_SalesReport_targetDate">
						...
						<div clsss="list_content">
							<div class="insertedContent">
								<div class="contentDiv">
									...
									<div
										style="border-top: 1px solid black;border-right: 1px solid black;padding: 0.3em;">
										<input type="text" class="inputs" id="doc_Form_SalesReport_title" data-detail=""
						...
						function keyUpFunction(obj) {
							if ($(".list_comment").attr("data-tag") == "writeTag") {
								...
								if (idType == "price") {
									...
									let total = quantity.next();
									quantity.val(0);
									total.val((obj.value.replace(/,/g, "") * quantity.val().replace(/,/g, "")).toLocaleString());
