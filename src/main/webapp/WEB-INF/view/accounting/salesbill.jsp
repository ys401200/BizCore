...
<div id="bodyContents">
	...
	<div id="bodyContent">
        <div class="searchContainer">
            ...
            <div class="searchMultiContent">
                <div class="searchCustomer">
                    <span>거래처</span>
                    <input type="text" data-complete="customer" autocomplete="off" id="searchBuyerCustomer" onclick="addAutoComplete(this);" onkeyup="addAutoComplete(this);">
                </div>
        ...
        <div class="salesbillContainer">
            ...
            <div class="listRange">
                <input type="range" class="listRangeInput" max="100" step="10" value="0" oninput="listRangeChange(this, drawSalesbillList);">
