...
public class ApiTradeCtrl extends Ctrl {
    ...
    public String ApiTradeFuncGet(HttpServletRequest request, @PathVariable("funcName") String funcName,
            @PathVariable("funcNo") String funcNo) {
    ...
    @PostMapping("")
    public String ApiTradePost(HttpServletRequest request, @RequestBody String requestBody)
        ...
        if (compId == null) {
            ...
            detail = mapper.readValue(data, Trade.class);
            if (tradeService.addTradeDetail(detail, compId)) {
                result = "{\"result\":\"ok\"}";
            } else {
    ...
    // @PutMapping("{no}")
    public String ApiTradePut(HttpServletRequest request, @RequestBody String requestBody,
            @PathVariable("no") String no) throws JsonMappingException, JsonProcessingException {
        String result = null;
        String compId = null;
        String aesKey = null;
        String aesIv = null;
