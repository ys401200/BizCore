...
public class ApiNoticeCtrl extends Ctrl {
    ...
    @RequestMapping(value = "", method = RequestMethod.GET) // 공지사항 목록
    ...
    @RequestMapping(value = "/*", method = RequestMethod.DELETE) // 공지사항 삭제
    ...
    @RequestMapping(value = "/*", method = RequestMethod.GET) // 공지사항 조회
    public String getDetail(HttpServletRequest req) {
        HttpSession session = null;
        String compId, aesIv, aesKey = null;
        String result = null;
        String data = null;
        String notiNo = null;
        String uri = req.getRequestURI();
    ...
    @RequestMapping(value = "/*", method = RequestMethod.POST) // 공지사항 추가
    ...
    @RequestMapping(value = "/*", method = RequestMethod.PUT) // 공지사항 수정
