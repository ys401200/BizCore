...
public interface MaintenanceMapper {
    ...
    @Insert("Insert into bizcore.maintenance (compId, contract, customer, product, startDate, endDate, engineer, related, created) values (#{compId},(select `no` from bizcore.contract  where related like concat('%','{\"parent\":\"sopp:',#{sopp},'\"','%')),#{customer},#{product},#{startDate},#{endDate},#{engineer},#{related},now())")
