class EmployeeSet {
  ...
  clickedDeptAdd() {
    var cnt, el, x, ids = [], names = [], border = "1px solid #2147b1", padding = "0.4rem", font = "0.9rem";
  ...
  collectDeptData(e) {
    ...
    if (n === "name") {
      ...
      if (JSON.stringify(storage.basic[n] !== null ? storage.basic[n].sort() : storage.basic[n]) ===
